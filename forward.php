			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="forward.php">ارجاع</a></li>
						<li class="pull-right">
	...
	<!-- START PAGE CONTENT-->
		...
		<form class="inbox-compose form-horizontal" id="form1" name="form1" action="letter-forward.php?action=forward&parID=<?php echo $letterIDs;?>" method="POST" enctype="multipart/form-data">
			...
			<div class="inbox-form-group">
				...
				<input type="text" name="subject" id="subject" class="form-control col-md-12" value="<?php echo ("ارجاع : ".$subject); ?>">
			</div>
			...
			<div class="form-group">
				<select class="form-control" name="actionType" id="actionType" value="<?php echo $actionType; ?>">
					<option id="op1" value="">اقدام مورد نظر را وارد کنید</option>
					<option id="op2" value="جهت اقدام">جهت اقدام</option>
					<option id="op3" value="جهت اطلاع">جهت اطلاع</option>
					<option id="op4" value="جهت امضا">جهت امضا</option>
					<option id="op5" value="جهت اقدام فوری">جهت اقدام فوری</option>
					<option id="op6" value="جهت بررسی و اقدام لازم">جهت بررسی و اقدام لازم</option>
					<option id="op7" value="جهت صدور دستور لازم">جهت صدور دستور لازم</option>
					<option id="op8" value="جهت استحضار">جهت استحضار</option>
				</select>
			</div>
...
<!-- ck Editor-->
	...
	<script>
		$(document).ready(function(){
			...
			if(document.getElementById('op2').value == "<?php echo $actionType ;?>")
				document.getElementById('op2').setAttribute("selected","");
			if(document.getElementById('op3').value == "<?php echo $actionType ;?>")
				document.getElementById('op3').setAttribute("selected","");
			if(document.getElementById('op4').value == "<?php echo $actionType ;?>")
				document.getElementById('op4').setAttribute("selected","");
			if(document.getElementById('op5').value == "<?php echo $actionType ;?>")
				document.getElementById('op5').setAttribute("selected","");
			if(document.getElementById('op6').value == "<?php echo $actionType ;?>")
				document.getElementById('op6').setAttribute("selected","");
			if(document.getElementById('op7').value == "<?php echo $actionType ;?>")
				document.getElementById('op7').setAttribute("selected","");
			if(document.getElementById('op8').value == "<?php echo $actionType ;?>")
				document.getElementById('op8').setAttribute("selected","");
			if( "1" == "<?php echo $private ;?>")
				{
					document.getElementById('optionsRadios2').setAttribute("value","0");	
					document.getElementById('optionsRadios1').setAttribute("value","1");
				}
				else
				{
					document.getElementById('optionsRadios2').setAttribute("value","1");	
					document.getElementById('optionsRadios1').setAttribute("value","0");
				}
		});
	</script>
	<script>
